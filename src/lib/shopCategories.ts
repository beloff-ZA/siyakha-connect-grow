...
export function categorise(p: ShopifyProduct): CategoryId {
  ...
  if (/(notebook|laptop|macbook|mac mini|imac|desktop pc|gaming desktop|gaming pc|mini pc|mini desktop|vivobook|tuf gaming|asus pro|workstation|chromebook|surface|graphics card|\bgpu\b|geforce|rtx \d|radeon)/.test(hay)) return "computers";
