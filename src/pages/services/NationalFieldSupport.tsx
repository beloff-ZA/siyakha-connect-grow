          ...
          <div className="container mx-auto px-4 lg:px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
            <article className="md:col-span-2 space-y-8">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4 text-muted-foreground">
                  <ul className="space-y-2">
                    ...
                    <li>• Cutovers and branch WAN migrations</li>
                  </ul>
                  <ul className="space-y-2">
                    <li>• Laptop rollouts, imaging and asset tagging</li>
                    <li>• Break/fix with parts logistics</li>
                    <li>• SIM card swaps and activations (LTE primary/failover)</li>
              ...
              <div className="pt-2 space-x-3">
                ...
                <Link to="/services/national-field-support/cutovers-and-sim-replacements">
                  <Button variant="outline">Learn more: Cutovers & SIM swaps</Button>
                </Link>
              </div>
            </article>
            ...
            <aside className="space-y-6">
              <div className="p-6 rounded-lg bg-muted">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li>• SIM card replacement & activation</li>
                </ul>
              </div>
              <div className="p-6 rounded-lg bg-muted">
