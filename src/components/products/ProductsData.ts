...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 18000,
    image: "/lovable-uploads/premium-support-25-50.png",
    description: "Professional managed IT support for medium to large businesses with 25–50 users. Includes unlimited remote support, dedicated account manager, 24/7 network monitoring, server management, and priority response times. Perfect for organisations requiring proactive IT management.",
    features: [
  ...
  {
    id: "sy-enterprise-50plus",
    name: "Enterprise Support | 50+ Users",
    sku: "SY-ENTERPRISE-50",
    price: 28000,
    image: "/lovable-uploads/premium-support-25-50.png",
    description: "Enterprise-grade IT support for large organisations and critical operations with 50+ users. Includes 24/7 support, on-call engineer, disaster recovery planning, advanced cybersecurity, dedicated helpdesk line, and optional onsite support. Built for businesses that cannot afford downtime.",
    features: [
      { icon: Clock, text: "24/7 Support" },
      { icon: UserCheck, text: "On-Call Engineer" },
      { icon: HardDrive, text: "Disaster Recovery" },
      { icon: Shield, text: "Cybersecurity" },
      { icon: Headphones, text: "Dedicated Line" },
      { icon: Users, text: "Onsite Optional" },
    ],
    highlights: [
      "24/7 round-the-clock support coverage",
      "Dedicated on-call engineer for emergencies",
      "Disaster recovery planning and testing",
      "Advanced cybersecurity and threat monitoring",
      "Dedicated helpdesk phone line",
      "Optional onsite support visits",
