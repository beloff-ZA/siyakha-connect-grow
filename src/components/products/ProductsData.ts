...
export const products: Product[] = [
  ...
  {
    id: "gs-gwn7661e",
    name: "Grandstream Enterprise WiFi 6 In-Wall Indoor Access Point | GWN7661E",
    sku: "GS-GWN7661E",
    manufacturerSku: "GWN7661E",
    price: 2349,
    image: "/lovable-uploads/gwn7661e-front.png",
    boxImage: "/lovable-uploads/gwn7661e-angle.png",
    description: "The Grandstream GWN7661E AX3000 Wi-Fi 6 in-wall Access Point delivers high-performance networking for offices, hotels, apartments, and smart homes. It offers 3Gbps wireless throughput and includes four Gigabit LAN ports for reliable wired and wireless connectivity. Supporting up to 256 concurrent clients with smooth voice-over-Wi-Fi performance.",
    features: [
      { icon: Wifi, text: "WiFi 6 AX3000" },
      { icon: Signal, text: "3Gbps Speed" },
      { icon: Users, text: "256 Clients" },
      { icon: Network, text: "4× GbE LAN Ports" },
      { icon: Shield, text: "PoE/PoE+ Support" },
      { icon: Server, text: "Embedded Controller" },
    ],
    highlights: [
      "2x2:2 MU-MIMO on 2.4 GHz and 3x3:2 MU-MIMO with OFDMA on 5 GHz",
      "Supports up to 256 concurrent clients",
      "4× Gigabit LAN ports for wired connectivity",
      "Advanced QoS and strong security protocols",
      "PoE and PoE+ support",
      "Built-in controller managing up to 50 Access Points",
      "Managed via Grandstream Device Management System (GDMS)",
      "Free cloud and on-premise management solutions",
    ],
    category: "Wi-Fi",
    brand: "Grandstream",
    warranty: "3 Year",
  ...
  {
    id: "gs-gxv3350",
    name: "Grandstream 16 Line Enterprise Video Phone | GXV3350",
    sku: "GS-GXV3350",
    manufacturerSku: "GXV3350",
    price: 2499,
    image: "/lovable-uploads/gxv3350-front.png",
    boxImage: "/lovable-uploads/gxv3350-angle.png",
    description: "The GXV3350 is a 16-Line video phone for Android. It combines the features of a multi-platform video collaboration solution and the functionality of an Android tablet, to offer an all-in-one communications solution. Features a 5 inch 1280x720 touch screen, tiltable camera, HDMI output, dual microphones and 720p HD video support.",
    features: [
      { icon: Video, text: "720p HD Video" },
      { icon: Monitor, text: "5\" Touch Screen" },
      { icon: Mic, text: "Dual Microphones" },
      { icon: Network, text: "Dual GbE Ports" },
      { icon: Smartphone, text: "Android 7.0" },
      { icon: Users, text: "16 SIP Accounts" },
    ],
    highlights: [
      "16 Lines with up to 16 SIP accounts",
      "5 inch 1280×720 capacitive touch screen",
      "Tiltable camera with 720p HD video",
