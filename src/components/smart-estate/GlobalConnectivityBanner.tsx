import globalImage from "@/assets/global-connectivity-network.jpg";
  ...
  return (
    <section className="relative bg-background border-t border-border">
      <div className="relative w-full h-[60vh] md:h-[80vh] overflow-hidden">
        <img
          src={globalImage}
          alt="Global connectivity network linking cities, continents and wireless infrastructure"
...
export default GlobalConnectivityBanner;
