...
-- 3) Profiles (link to auth.users), use this instead of referencing auth.users everywhere
...
create trigger call_assignments_set_updated_at
...
-- Storage policies (initial; will refine with path conventions and edge functions)
-- Admin full access
